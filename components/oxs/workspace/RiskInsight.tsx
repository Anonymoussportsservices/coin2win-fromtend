...
export function RiskInsight(props: RiskInsightProps) {
  const result = runRiskBrain(props);
  ...
  return (
    <div className="rounded-2xl border border-white/5 bg-[#13202a] p-4">
      <div className="flex items-start justify-between gap-3">
        <div>
          <div className="text-xs font-black uppercase tracking-[0.16em] text-slate-500">Risk Insight</div>
